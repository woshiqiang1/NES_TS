...
export interface MappersInterface {
  0?: typeof C;
  1?: typeof C1;
  2?: typeof C2;
  3?: typeof C3;
...
class C4 extends C {
  ...
  command: null | number = null
  prgAddressSelect: null | number = null;
  chrAddressSelect: null | number = null;
  pageNumber: null | number = null;
  irqCounter: null | number = null;
  irqLatchValue: null | number = null;
  irqEnable: null | number = null;
  prgAddressChanged: boolean = false;
...
class C5 extends C {
  ...
  sram_we_b: number
  graphic_mode: number
  nametable_mode: number
  nametable_type: number[]
  fill_chr: number
  fill_pal: number
  chr_mode: number
  chr_page: number[][]
  split_control: number
  split_scroll: number
  split_page: number
  irq_line: number
  irq_enable: number
