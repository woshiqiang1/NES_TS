...
class PPU {
  ...
  // Keep Chrome happy
  vramMem: null | number[] = null
  spriteMem: null | number[] = null;
  vramAddress: null | number = null;
  vramTmpAddress: null | number = null;
  vramBufferedReadValue: null | number = null;
  firstWrite: null | boolean = null;
  sramAddress: null | number = null;
  currentMirroring: null | number = null; // Duplicated in source js code
  requestEndFrame: null | boolean = null;
  nmiOk: null | boolean = null;
  dummyCycleToggle: null | boolean = null;
  validTileData: null | boolean = null; // Duplicated in source js code
  nmiCounter: null | number = null;
  scanlineAlreadyRendered: null | boolean = null;
  f_nmiOnVblank: null | number = null;
  f_spriteSize: null | number = null;
  f_bgPatternTable: null | number = null;
  f_spPatternTable: null | number = null;
  f_addrInc: null | number = null;
  f_nTblAddress: null | number = null;
  f_color: null | number = null;
  f_spVisibility: null | number = null;
  f_bgVisibility: null | number = null;
  f_spClipping: null | number = null;
  f_bgClipping: null | number = null;
  f_dispType: null | number = null;
  cntFV: null | number = null;
  cntV: null | number = null;
  cntH: null | number = null;
  cntVT: null | number = null;
  cntHT: null | number = null;
  regFV: null | number = null;
  regV: null | number = null;
  regH: null | number = null;
  regVT: null | number = null;
  regHT: null | number = null;
  regFH: null | number = null;
  regS: null | number = null;
  curNt: null | number = null;
  attrib: null | number[] = null;
  buffer: null | number[] = null;
  bgbuffer: null | number[] = null;
  pixrendered: null | number[] = null;

  scantile: null | any[] = null;
  scanline: null | number = null;
  lastRenderedScanline: null | number = null;
  curX: null | number = null;
  sprX: null | number[] = null;
  sprY: null | number[] = null;
  sprTile: null | number[] = null;
  sprCol: null | number[] = null;
  vertFlip: null | boolean[] = null;
  horiFlip: null | boolean[] = null;
  bgPriority: null | boolean[] = null;
  spr0HitX: null | number = null;
  spr0HitY: null | number = null;
  hitSpr0: null | boolean = null;
  sprPalette: null | number[] = null;
  imgPalette: null | number[] = null;
  ptTile: null | any[] = null;
  ntable1: null | number[] = null;
  nameTable: null | any[] = null;
  vramMirrorTable: null | number[] = null;
  palTable: null | PaletteTable = null;
  ...
  reset() {
    ...
    for(i = 0; i < this.vramMem.push.length; i++) {
      this.vramMem[i] = 0
    }
  ...
  setStatusFlag(flag: number, value: boolean) {
    let n = 1 << flag;
