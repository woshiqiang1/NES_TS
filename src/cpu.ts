...
class CPU {
  ...
  mem: null | number[] = null
  REG_ACC: null | number = null;
  REG_X: null | number = null;
  REG_Y: null | number = null;
  REG_SP: null | number = null;
  REG_PC: null | number = null;
  REG_PC_NEW: null | number = null;
  REG_STATUS: null | number = null;
  F_CARRY: null | number = null;
  F_DECIMAL: null | number = null;
  F_INTERRUPT: null | number = null;
  F_INTERRUPT_NEW: null | number = null;
  F_OVERFLOW: null | number = null;
  F_SIGN: null | number = null;
  F_ZERO: null | number = null;
  F_NOTUSED: null | number = null;
  F_NOTUSED_NEW: null | number = null;
  F_BRK: null | number = null;
  F_BRK_NEW: null | number = null;
  opdata: null | number[]= null;
  cyclesToHalt: null | number = null;
  crash: null | boolean = null;
  irqRequested: null | boolean = null;
  irqType: null | Number = null;
  ...
  // Emulates a single CPU instruction, return the number of cycles
  emulate() {
    let temp: number
    let add
  ...
  doNonMaskableInterrupt(status: number) {
    if((this.nes.mmap.load(0x2000) & 128) !== 0) {
      // Check whether VBlank Interrupts are enable
